...
import ar.com.wolox.android.example.TrainingAndroid
...
interface AppComponent : AndroidInjector<TrainingAndroid> {

    @Component.Builder
    abstract class Builder : AndroidInjector.Builder<TrainingAndroid>() {
